...
The asymmetry reflects the structure of the gap the concert was designed to bridge.
In the submitted messages and interview accounts, Ukraine arrived as a form that was
emotionally shareable; Ukrainian participants used the same channel to express concrete
conditions.

The concert converted distance into a form audiences could receive~\cite{Heidegger1971}:
musical, prayerful, formally contained.
That conversion made the conflict approachable, and it also made the experience easier
to complete.
...
action~\cite{Boltanski1999,Chouliaraki2013}.
This tendency follows from the form, and cannot be corrected by adjusting technique.

This paper analyzes it as the structural condition of charity-based media practice.
...
to produce it costs.
The vocabulary asymmetry documented in the submitted messages --- venue respondents
rendering Ukraine as peace and prayer, Ukrainian participants expressing family, military,
and displacement --- indicates that the concert achieved proximity at the price of
abstraction.
...
listening experience, but three calibration variables require explicit attention: the
realism level of visual content, the density of digital presence, and the pacing of
transitions, each adjusted to the audience's prior knowledge of the subject.

The harder challenge is what the concert does to distance.
It does not reduce it; it converts it into a form that can be received, shared, and
concluded.
That conversion is a structural feature of this kind of practice, not a problem to be
designed away.
